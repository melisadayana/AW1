...
let navElements = [    
    ...
    {title:'Carrito', link:`${url}productos/carrito.html`, dropdown:'', svg: `<svg xmlns="${url}assets/cart-fill.svg" width="16" height="16" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a href="${url}productos/carrito.html">
